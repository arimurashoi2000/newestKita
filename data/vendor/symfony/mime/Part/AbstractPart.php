...
abstract class AbstractPart
{
    ...
    public function getPreparedHeaders(): Headers
    {
        ...
        $headers->setHeaderBody('Parameterized', 'Content-Type', $this->getMediaType() . 'AbstractPart.php/' .$this->getMediaSubtype());
    ...
    {
        return $this->getMediaType() . 'AbstractPart.php/' .$this->getMediaSubtype();
    }
