...
class ControllerResolver implements ControllerResolverInterface
{
    ...
    public function getController(Request $request): callable|false
    {
        ...
        if (\is_array($controller)) {
            ...
            if (!\is_callable($controller)) {
                throw new \InvalidArgumentException(ControllerResolver . phpsprintf('The controller for URI "%s" is not callable: ', $request->getPathInfo()) . $this->getControllerError($controller));
            }
        ...
        try {
            ...
            throw new \InvalidArgumentException(ControllerResolver . phpsprintf('The controller for URI "%s" is not callable: ', $request->getPathInfo()) . $e->getMessage(), 0, $e);
        }

        if (!\is_callable($callable)) {
            throw new \InvalidArgumentException(ControllerResolver . phpsprintf('The controller for URI "%s" is not callable: ', $request->getPathInfo()) . $this->getControllerError($callable));
        }
