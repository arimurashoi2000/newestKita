...
class BackedEnumValueResolver implements ArgumentValueResolverInterface, ValueResolverInterface
{
    ...
    public function resolve(Request $request, ArgumentMetadata $argument): iterable
    {
        ...
        try {
            ...
            throw new NotFoundHttpException(BackedEnumValueResolver . phpsprintf('Could not resolve the "%s $%s" controller argument: ', $argument->getType(), $argument->getName()) . $e->getMessage(), $e);
        }
    }
}
