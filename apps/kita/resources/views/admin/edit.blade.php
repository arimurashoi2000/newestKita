...
@section('content')
    <div class="container">
            ...
            <div class="col-md-9 col-12">
                <div class="border rounded bg-white py-3">
                    ...
                    <div class="col px-4 my-4">
                        ...
                        <p class="col-auto rounded bg-secondary text-black">{{$admin_user->id}}</p>
                    </div>
                    <!--姓-->
                    <div class="col px-4 my-4">
                        <div class="row">
                    ...
                    <div class="col px-4 my-4">
                        ...
                        <p class="col-auto rounded bg-secondary text-black">{{$admin_user->updated_at}}</p>
                    </div>
                    <!--登録日時-->
                    <div class="col px-4 my-4">
                        <div class="row">
                        ...
                        <p class="col-auto rounded bg-secondary text-black">{{$admin_user->created_at}}</p>
                    </div>
                </div>
            </div>
        ...
        {{ Form::close() }}
                    <!--削除ボタン-->
                    <div class="col-md-12 col-12 text-center py-2">
                        {{ Form::open(['route' => ['admin_users.destroy', $admin_user], 'style' => 'display: inline-block;']) }}
                        @csrf
                        @method('delete')
